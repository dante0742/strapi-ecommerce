...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cart_status: Schema.Attribute.Enumeration<['active', 'checked_out']> &
      Schema.Attribute.DefaultTo<'active'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'shared.cart-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    child_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::category.category'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Media<'images' | 'files'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    billing_address: Schema.Attribute.Component<'shared.address', true>;
    created_last: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    payment_method: Schema.Attribute.Enumeration<['MPESA', 'Stripe']>;
    publishedAt: Schema.Attribute.DateTime;
    shipping_address: Schema.Attribute.Component<'shared.address', true>;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    paid_at: Schema.Attribute.DateTime & Schema.Attribute.Required;
    payment_method: Schema.Attribute.Enumeration<['MPESA', 'Stripe']>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    discount_price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    ...
    ProductAttributes: Schema.Attribute.Component<'shared.attributes', true>;
    published_last: Schema.Attribute.DateTime & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiShippingMethodShippingMethod
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estimated_delivery_time: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shipping-method.shipping-method'
    ...
    publishedAt: Schema.Attribute.DateTime;
    shipping_zones: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiShippingZoneShippingZone
  ...
  attributes: {
    countries: Schema.Attribute.Enumeration<
...
export interface ApiVendorVendor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    wallet_balance: Schema.Attribute.Decimal;
  };
}
...
export interface ApiVoucherVoucher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    min_order_value: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
